...
def solverBuilders() -> dict[str, SolverBuilder]:
    return {
        ...
        "bsma_numba_literature": lambda: BSMANumbaSolver(),
        "bsma_numba_transfer_literature": lambda: BSMANumbaSolver(),
        "bsma_numba_v2": lambda: BSMANumbaSolverV2(),
        "bsca": lambda: BSCASolver(),
        "bsca_numba": lambda: BSCANumbaSolver(),
        "bsca_numba_literature": lambda: BSCANumbaSolver(),
        "bsca_numba_transfer_literature": lambda: BSCANumbaSolver(),
        ...
        "brlsmasca_numba_literature": lambda: BRLSMASCATestNumbaSolver(),
        "brlsmasca_numba_transfer_literature": lambda: BRLSMASCATestNumbaSolver(),
        "brlsmasca_numba_random50_transfer_literature": lambda: BRLSMASCATestNumbaSolver(),
        "brlsmasca_numba_random50_literature": lambda: BRLSMASCATestNumbaSolver(),
