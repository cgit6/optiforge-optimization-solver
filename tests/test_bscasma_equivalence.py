...
from mkp.valid.bscasma_population_trace import _compare_problem


def test_bscasma_population_trace_weish01_seed_101_bit_identical():
...
def test_bscasma_population_trace_weish01_three_seeds_bit_identical():
