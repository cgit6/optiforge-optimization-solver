...
class main:
    ...
    def __init__(self):
        ...
        self.output_folder = "output/gurobi/WEING"  # 设置输出資料夾路径
         # 問題參數
    ...
    def exe(self):
        ...
        for prob in self.problem:
            ...
            file_path = os.path.join(self.batch_directory, f"weing{prob}.dat") # 構建完整的文件路徑
            # 讀取題庫
            ...
            # result_name = f"{self.output_folder}/weing{prob}.csv"
